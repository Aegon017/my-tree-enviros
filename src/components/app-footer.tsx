...
import { Clock, Mail, MapPin, Phone, Facebook, Twitter, Instagram, Linkedin, Youtube } from "lucide-react";
...
const footerData = {
    contactInfo: {
        address: "4th Floor, Trendz Trinity, Plot No. 18, Madhagar, Safoornagar, Hyderabad, Telangana 500081",
        phone: "+91 8977730565",
    ...
    return (
        <footer className="bg-background border-t">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-muted-foreground">{ footerData.contactInfo.address }</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Phone className="h-5 w-5 text-muted-foreground flex-shrink-0" />
                                <span className="text-sm text-muted-foreground">{ footerData.contactInfo.phone }</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Mail className="h-5 w-5 text-muted-foreground flex-shrink-0" />
                                <span className="text-sm text-muted-foreground">{ footerData.contactInfo.email }</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Clock className="h-5 w-5 text-muted-foreground flex-shrink-0" />
                                <span className="text-sm text-muted-foreground">{ footerData.contactInfo.workingHours }</span>
                            </div>
            ...
            <div className="bg-primary text-primary-foreground flex flex-col md:flex-row justify-center items-center gap-4 p-4">
                <p className="text-sm text-center md:text-left">{ footerData.copyright }</p>
            </div>
        </footer>
    );
};
