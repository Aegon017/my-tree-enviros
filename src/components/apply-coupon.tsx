...
export function ApplyCoupon( { onCouponApplied, onCouponRemoved, currentTotal }: ApplyCouponProps ) {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Enter your coupon code to get discounts</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="space-y-4">
                    <div className="flex gap-2">
                        ...
                        />
                        { appliedCoupon ? (
                            <Button onClick={ handleChangeCoupon } disabled={ isMutating } variant="outline">
                                Change
                            </Button>
                        ) : (
                            <Button
                        ...
                        <div className="p-3 bg-muted rounded-lg">
                            <div className="flex justify-between items-center">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">{ appliedCoupon }</p>
                                </div>
