...
export const OrderTimeline = ({ order }: { order: any }) => {
    ...
    const shippableSteps = [
        {
            ...
            date: order?.tracking?.shipped_at
        ...
        },
        {
            ...
            current: ["delivered", "completed"].includes(order?.status),
            date: order?.tracking?.delivered_at
    ...
    const steps = [
        ...baseSteps,
        ...(isShippable ? shippableSteps : digitalSteps),
    ];
            ...
            {order?.tracking?.tracking_id && (
                <div className="bg-muted/30 p-4 rounded-lg border flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 text-sm mt-6">
                    <div>
                        ...
                        <span className="font-medium ml-2 block sm:inline">
                    ...
                    <div>
                        ...
                        <span className="font-medium ml-2 font-mono block sm:inline">
                            {order.tracking.tracking_id}
                        </span>
                    </div>
