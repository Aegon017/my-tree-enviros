  ...
  const products: Product[] = [
    {
      ...
      name: "Neem Powder",
      description:
        "Pure organic neem powder for skincare and health benefits. 100% natural and chemical-free.",
      originalPrice: "59.00",
    ...
    },
    {
      ...
      name: "Neem Oil",
      description:
        "Cold-pressed neem oil for hair care and organic farming. Free from additives.",
      originalPrice: "79.00",
    ...
    },
    {
      ...
      name: "Neem Soap",
      description:
        "Ayurvedic neem soap for clear and healthy skin. Gentle and effective.",
      originalPrice: "45.00",
  ...
  const blogPosts: BlogPost[] = [
    {
      ...
      description:
        "Discover how trees combat climate change and create a healthier planet for all.",
      commentCount: 0,
      imageUrl: neemTree,
    ...
    },
    {
      ...
      description:
        "Learn about eco-friendly farming techniques that protect our environment.",
      commentCount: 3,
      imageUrl: neemTree,
    ...
    },
    {
      ...
      description:
        "Explore the many health benefits of neem and how it's used today.",
      commentCount: 7,
      imageUrl: neemTree,
    ...
    },
    {
      ...
      description:
        "How community gardens foster connections and promote sustainable living.",
      commentCount: 2,
      imageUrl: neemTree,
    ...
    },
    {
      ...
      description:
        "Why cities need diverse plant life and how to incorporate it.",
      commentCount: 5,
      imageUrl: neemTree,
