                ...
                <div className="mx-auto max-w-5xl">
                    <Card className="border shadow-sm">
                        <CardContent className="prose prose-neutral dark:prose-invert max-w-none px-6 py-6">
                            ...
                            <p>
                                <strong>How to Cancel:</strong> To request a cancellation, please
                                get in touch with our Customer Support Team immediately with your
                                Order ID via email at
                            ...
                            <p>
                                <strong>Note:</strong> Minor leaf damage, slight wilting, or soil
                                spillage is normal during transit and does not qualify for a
                                replacement, as these issues are typically resolved with proper
                                watering and care.
                            </p>

                            <p>
                                <strong>
                                    Non-Plant Products (Planters, Tools, Supplies):
                                </strong>{" "}
                                ...
                                <Card>
                                    <CardContent className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p>
                                                Reshipment: Shipping charges must be paid again by
                                                the customer.
                                            </p>
                                            <p>
                                                Refund: The refund will be processed after a 25%
                                                deduction from the total order value to cover
                                                initial shipping, handling, and logistics costs.
                                            </p>
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card>
                                    <CardContent className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p>
                                                Refund: A deduction of 25% of the total order value
                                                will apply.
                                            </p>
                                        </div>
                                    </CardContent>
                                ...
                                <Card>
                                    <CardContent className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p>
                                                A 25% deduction from the total order value will
                                                apply. Prepaid orders that are refused are not
                            ...
                            <p>
                                <strong>Refund Method:</strong> All refunds will be credited back
                                to the original source of payment (e.g., credit card, debit card,
                                bank account, or digital wallet). The time it takes for the
                                credit to appear in your account depends on your bank.
                            </p>

                            <p>
                                <strong>Products Purchased on Sale:</strong> Items purchased at a
                                discounted price or during a sale are not eligible for a
