        ...
        <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-hidden">
          ...
          <ScrollArea className="h-[400px] pr-4">
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="message" className="text-sm font-medium">Special Message</label>
                <textarea
                  name="message"
      ...
      <CardContent className="p-4 md:p-6">
        <div className="flex items-start gap-4 md:gap-6">
          ...
          <div className="flex-1 min-w-0 space-y-3 md:space-y-4">
            <div>
              <h3 className="font-semibold text-base md:text-lg truncate">{ productName }</h3>
              { !isTreeProduct && (
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center border border-input rounded-md bg-background">
                  ...
                  <Button
                    ...
                    onClick={ () => handleQuantityChange( item.quantity + 1 ) }
                    disabled={ item.quantity >= ( item.ecom_product?.quantity || item.product?.quantity ) || isUpdating }
                  >
            ...
            { isTreeProduct && (
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="text-sm space-y-1 text-foreground">
                  ...
                  { item.occasion && <p><span className="font-medium">Occasion:</span> { item.occasion }</p> }
                  { item.message && <p><span className="font-medium">Message:</span> { item.message }</p> }
                </div>
              </div>
            ) }
          </div>
          ...
          <div className="flex flex-col items-end gap-3 md:gap-4">
            <p className="text-lg md:text-xl font-bold text-foreground">₹{ ( itemPrice * item.quantity ).toFixed( 2 ) }</p>
            <Button
              variant="ghost"
              size="icon"
