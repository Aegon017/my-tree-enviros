...
export default function ProductPage({ params }: Props) {
  ...
  const productImage = useMemo(
    () =>
      ...
      "/placeholder.jpg",
    [selectedImages, currentImageIndex, product?.thumbnail_url],
  );
  ...
  const maxStock = useMemo(
    () =>
      selectedVariant
        ...
        : product?.default_variant?.stock_quantity ||
  ...
  const displayBasePrice = useMemo(
    () =>
      selectedVariant
        ...
        : product?.default_variant?.base_price,
    [selectedVariant, product],
  );
  ...
  const isInStock = useMemo(
    () =>
      product?.has_variants
        ...
        : product?.default_variant?.is_instock ||
  ...
  }, [product, selectedColor, selectedPlanter]);
                    ...
                    <div className="bg-muted p-4 rounded-lg">
                      ...
                      {!selectedVariant.is_instock && (
                        <div className="mt-2 text-xs text-muted-foreground">
                          Please select a different combination or check back
                          later.
                        </div>
                      )}
                    </div>
                  ...
                  {product.has_variants &&
                    ...
                    !selectedVariant && (
                      <div className="bg-destructive/10 border border-destructive/20 p-4 rounded-lg">
                        <span className="text-destructive text-sm">
                          The selected combination is not available. Please
