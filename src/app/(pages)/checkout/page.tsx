...
export default function CheckoutPage() {
  ...
  if (isLoading && !cartData) {
    return (
      <div className="container max-w-6xl mx-auto px-4 py-8 min-h-screen pt-32">
                ...
                {cartItems.map((item) => (
                  <div key={item.id} className="flex items-start space-x-4 p-4 border rounded-lg bg-card/50">
                    <div className="shrink-0">
                      ...
                      <img
                        src={item.image_url || item.item?.image || "/placeholder.png"}
          ...
          <Card className="sticky top-24">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="pt-6">
                  <RazorpayButton
                    type={4} // PaymentType.ORDER
                    productType={2} // ProductType.PRODUCT (Defaulting to product for mixed cart, or logic needs to be smarter if mixed)
                    shippingAddressId={selectedAddressId ?? 0}
                    amount={orderTotal}
                    cartType={1} // CartType.CART
